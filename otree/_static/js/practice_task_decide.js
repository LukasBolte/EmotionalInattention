...
function task(parameters){
    ...
    this.draw1=function(){
        ...
        p.innerHTML="$"+ Number.parseFloat(amount).toFixed(2);
    ...
    this.draw2=function(){
        ...
        endPracticeButton.setAttribute("id","continueButton_id")
        endPracticeButton.className="btn btn-primary btn-large";
        endPracticeButton.style="visibility: hidden;"
        ...
        if (this.practice_boxes-this.num_draws==0){
            ...
            p.setAttribute("id","endPratice_text_id")
            p.style="visibility: hidden;"
            if (this.practice){
                p.innerHTML='You have opened all the boxes. Click "Next" to continue to the real task.'
            } else {
                p.innerHTML='You have opened all the boxes. Click "Next" to continue to the real task.'
            }
            td.appendChild(p)
